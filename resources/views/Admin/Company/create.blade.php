       ...
       <div class="row">
           <div class="col-lg-6 offset-lg-3 ">
            <div class="card">
                ...
                <div class="card-body">
                        <form id="companyId"   method="POST" action="{{ route('company.store') }}" class="justify-content-center" enctype="multipart/form-data">
                            @csrf
                                <div class="mb-3 ">
                                ...
                                <div class="mb-3 ">
                                    ...
                                    <input type="text" name="email" placeholder="Enter Your Company Email" class="form-control " value="{{ old('email') }}">
                                    @error('email')
                                    <span class="text-danger ">{{ $message }}</span>
                                     @enderror
                                </div>
                                ...
                                <div class="mb-3 text-center">
                                    <button class="btn btn-primary btnSubmit" type="submit" name="Add Company">Add Company</button>
